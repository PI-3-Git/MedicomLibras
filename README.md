...
Os objetivos deste projeto são a aprimoração do produto MedicomLibras, desenvolvido pelos autores em 2024 e já em funcionamento, acrescentando ao produto um hardware leitor de QRCode para, neste momento, identificação do usuário e encaminhamento ao guichê de atendimento adequado.
